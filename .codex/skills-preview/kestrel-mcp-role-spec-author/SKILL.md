...
description: >
  RFC author persona for writing crisp executable specs. Trigger on RFC author mode, spec-author persona, or write RFC as an architect.
---
...
- D:\TG PROJECT\redteam-mcp\.cursor\skills-cursor\kestrel-mcp\roles\spec-author\SKILL.md
