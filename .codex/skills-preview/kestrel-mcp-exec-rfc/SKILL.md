...
description: >
  Execute one RFC in this repo. Trigger on run RFC-NNN, implement RFC-NNN, 鎵ц RFC, or when bootstrap routes here.
---
...
- D:\TG PROJECT\kestrel-mcp\.cursor\skills-cursor\kestrel-mcp\exec\rfc\SKILL.md
