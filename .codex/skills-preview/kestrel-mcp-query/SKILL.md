...
description: >
  Answer status questions about RFCs, threats, next steps, and metrics. Trigger on 鏌ヨ繘搴? next RFC, what's done, or progress report.
---
...
- D:\TG PROJECT\kestrel-mcp\.cursor\skills-cursor\kestrel-mcp\query\SKILL.md
