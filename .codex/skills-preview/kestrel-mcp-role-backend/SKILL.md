...
description: >
  Execution persona for implementing RFCs. Trigger on backend engineer mode, 鎵ц妯″紡, or implement RFC with disciplined habits.
---
...
- D:\TG PROJECT\redteam-mcp\.cursor\skills-cursor\kestrel-mcp\roles\backend-engineer\SKILL.md
