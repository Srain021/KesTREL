...
description: >
  Write a new RFC or split an oversized RFC. Trigger on 鎶?X 鍐欐垚 RFC, draft RFC, split RFC, or plan implementation.
---
...
- D:\TG PROJECT\redteam-mcp\.cursor\skills-cursor\kestrel-mcp\plan\SKILL.md
