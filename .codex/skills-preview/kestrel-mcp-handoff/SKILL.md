...
description: >
  Create or restore a project handoff snapshot. Trigger on 蹇収, 浜ゆ帴, resume, snapshot progress, or restore session.
---
...
- D:\TG PROJECT\redteam-mcp\.cursor\skills-cursor\kestrel-mcp\handoff\SKILL.md
