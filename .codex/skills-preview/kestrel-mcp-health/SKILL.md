...
description: >
  Run repo health checks or rollback workflow. Trigger on 鍋ュ悍妫€鏌? rollback, verify, full_verify, or fix broken baseline.
---
...
- D:\TG PROJECT\redteam-mcp\.cursor\skills-cursor\kestrel-mcp\health\SKILL.md
