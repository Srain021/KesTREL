...
description: >
  Execute multiple RFCs in DAG order. Trigger on 杩炵画鎵ц RFC, batch RFC chain, or sequential RFC rollout.
---
...
- D:\TG PROJECT\redteam-mcp\.cursor\skills-cursor\kestrel-mcp\exec\rfc-chain\SKILL.md
